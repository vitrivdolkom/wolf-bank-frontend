...
export function useGetApiV1BankAccount<
  ...
  TError = unknown
>(
  params: undefined | GetApiV1BankAccountParams,
  options: {
    query: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiV1BankAccount>>, TError, TData>
    > &
...
export const getApiV1BankAccountAll = (
  params?: GetApiV1BankAccountAllParams,
  options?: SecondParameter<typeof getInstance>,
  signal?: AbortSignal
) => {
  return getInstance<BankAccountDto[]>(
    { url: `/api/v1/BankAccount/all`, method: 'GET', params, signal },
    options
  );
};

export const getGetApiV1BankAccountAllQueryKey = (params?: GetApiV1BankAccountAllParams) => {
  return [`/api/v1/BankAccount/all`, ...(params ? [params] : [])] as const;
};

export const getGetApiV1BankAccountAllQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiV1BankAccountAll>>,
  TError = unknown
>(
  params?: GetApiV1BankAccountAllParams,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiV1BankAccountAll>>, TError, TData>
    >;
    request?: SecondParameter<typeof getInstance>;
  }
) => {
  ...
  const queryKey = queryOptions?.queryKey ?? getGetApiV1BankAccountAllQueryKey(params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiV1BankAccountAll>>> = ({ signal }) =>
    getApiV1BankAccountAll(params, requestOptions, signal);

  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof getApiV1BankAccountAll>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> };
};

export type GetApiV1BankAccountAllQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiV1BankAccountAll>>
>;
export type GetApiV1BankAccountAllQueryError = unknown;

export function useGetApiV1BankAccountAll<
  TData = Awaited<ReturnType<typeof getApiV1BankAccountAll>>,
  TError = unknown
>(
  params: undefined | GetApiV1BankAccountAllParams,
  options: {
    query: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiV1BankAccountAll>>, TError, TData>
    > &
...
>(
  ...
  const queryOptions = getGetApiV1BankAccountAllQueryOptions(params, options);
...
>(
  bankAccountId: string,
  params: undefined | GetApiV1BankAccountBankAccountIdHistoryParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getApiV1BankAccountBankAccountIdHistory>>,
